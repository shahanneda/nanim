...
objectsToDraw.append(Rectangle(200,200,20,20,Color(1,0,0) ))
objectsToDraw.append(Rectangle(200,100,20,20,Color(1,1,0) ))
objectsToDraw.append(Rectangle(100,100,20,20,Color(0.2,1,0) ))
